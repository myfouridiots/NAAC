                        ...
                        <form>
                            <nav aria-label="Page navigation ">
                                <ul class="pagination justify-content-end">
                                    <li class="page-item"><a class="page-link" href="#" onclick="previousSection()">Previous</a></li>
                                    ...
                                    <li class="page-item"><a class="page-link" href="#" onclick="nextSection()">Next</a></li>
                                </ul>
                            </nav>
                            <div id="long-form">
                                <div class="form-group form-section active" id="section1">

                                    <h3>for 2.4.1 & 2.4.3</h3>
                                    <label for="teacherName">Name of the Full-time Teacher:</label>
                                    <input type="text" id="teacherName" name="teacherName" class="form-control" required><br><br>
                                    ...
                                    <label for="stillServing">Is the Teacher Still Serving the Institution/If Not, Last Year of Service
                                        to the Institution:</label>
                                    <input type="text" id="stillServing" name="stillServing" required><br><br>

                                    <h3>for critera 2.4.2</h3>
                                    ...
                                    <label for="qualificationYear">Qualification (Ph.D./D.M/M.Ch./D.N.B Superspeciality/D.Sc./D’Lit.)
                                    ...
                                    <label for="stillServing">Is the Teacher Still Serving in the Institution/If Not, Last Year of
                                    ...
                                    <label for="resultDate">Date of Declaration of Results of Semester-End/Year-End Examination:</label>
                                    ...
                                    <label for="studentsAppeared">Number of Students Appeared in the Final Year Examination:</label>
                                ...
                                <div class="form-section" id="section2">
                                    ...
                                    <label for="policyLink">Link to the Policy Documents for Sanction of Seed Money/Grants for Research from
                                        the Institution:</label>
                                    <input type="text" id="policyLink" name="policyLink" required><br><br>

                                    <h3>for critera 3.1.3</h3>

                                    <label for="teacherName">Name of the Teacher Awarded National/International Fellowship/Financial
                                        Support:</label>
                                    <input type="text" id="teacherName" name="teacherName" required><br><br>
