  ...
  <script>
    $(document).ready(function() {
      $('#search-btn').click(function() {
        var role = $('#role').val();
      if (role === 'Teacher') {
          window.location.href = './teacher/registration.php';
          
          // window.location.href = './teacher/teacher-create.php';
        } else if (role === 'Student') {
          // window.location.href = './students/student-create.php';
          window.location.href = './students/registration.php';
