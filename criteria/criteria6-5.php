                                ...
                                <div class="card-body m-5 mt-1">
                                    <table id="example" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <?php
                                                $query = "SELECT teacher_id,year,conferences,aaaAction,nirfStatus,isoCertification,nbaCertification,collaborativeInitiatives,orientationProgramme,programmeDate FROM teacherform LIMIT 1";
                                        ...
                                        <tbody>
                                            <?php
                                            $query = "SELECT teacher_id,year,conferences,aaaAction,nirfStatus,isoCertification,nbaCertification,collaborativeInitiatives,orientationProgramme,programmeDate FROM teacherform";
                                            $query_run = mysqli_query($conn, $query);
