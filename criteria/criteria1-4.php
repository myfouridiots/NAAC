                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="text-center">&emsp;<b>Criteria 1-4 Students Records</b>
                                    <form method="post" action="../excel/Excel copy 4.php">
                                ...
                                <div class="card-body m-5 mt-1">
                                    <table id="example" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                        ...
                                        <thead>
                                            <tr>
                                                <?php
                                                $query = "SELECT id,programmeName,programmeCode,studentProjects,documentLink FROM studentform LIMIT 1";
                                        ...
                                        <tbody>
                                            <?php
                                            $query = "SELECT id,programmeName,programmeCode,studentProjects,documentLink FROM studentform";
                                            $query_run = mysqli_query($conn, $query);
