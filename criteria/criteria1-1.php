                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="text-center">&emsp;<b>Criteria 1-1 Students Records</b>
                                        <!-- <a href="../teacher/exportToExcel.php" class="btn btn-success btn-sm pull-right"><i class="fa-solid fa-download fa-xl"></i></a> -->
                                ...
                                <div class="card-body m-5 mt-1">
                                    <table id="example" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <?php
                                                $query = "SELECT id, programmeCode,programmeName,yearOfIntroduction,implementationStatus,yearOfRevision,documentLink FROM studentform LIMIT 1";
                                        ...
                                        <tbody>
                                            <?php
                                            $query = "SELECT id,programmeCode,programmeName,yearOfIntroduction,implementationStatus,yearOfRevision,documentLink FROM studentform";
                                            $query_run = mysqli_query($conn, $query);
