                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <form method="post" action="../excel/Excel copy 23.php">
                                ...
                                <div class="card-body m-5 mt-1">
                                    <table id="example" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <?php
                                                $query = "SELECT  teacher_id,roomName,ictFacility,photoLink,timetable FROM teacherform LIMIT 1";
                                        ...
                                        <tbody>
                                            <?php
                                            $query = "SELECT teacher_id,roomName,ictFacility,photoLink,timetable FROM teacherform";
                                            $query_run = mysqli_query($conn, $query);
