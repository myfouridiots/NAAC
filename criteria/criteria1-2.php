                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <form method="post" action="../excel/Excel 1-2.php">
                                ...
                                <div class="card-body m-5 mt-1">
                                    <table id="example" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <?php
                                                $query = "SELECT id,courseName,courseCode,courseContent,yearOfIntroduction,documentLink FROM studentform LIMIT 1";
                                        ...
                                        <tbody>
                                            <?php
                                            $query = "SELECT id,courseName,courseCode,courseContent,yearOfIntroduction,documentLink FROM studentform";
                                            $query_run = mysqli_query($conn, $query);
